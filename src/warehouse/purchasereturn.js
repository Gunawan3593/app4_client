...
const actions = {
    ...
    async getRtNo({ commit }){
        try {
            ...
            let res = await axios.get('http://localhost:5000/api/purchase/returns/getcode');
            if (res.data.success) {
    ...
    async getPurchaseReturn({ commit },id){
        ...
        try {
            commit('purchaseReturn_request');
            let res = await axios.get('http://localhost:5000/api/purchase/returns/data'+data);
            if (res.data.success) {
                commit('purchaseReturn_success', res);
            }else{
                return commit('purchaseReturn_error',res);
    ...
    async getRtItem ({ commit }, data) {
        try {
            commit('purchaseReturn_request');
            let res = await axios.post('http://localhost:5000/api/purchase/returns/item', data);
    ...
    async addPurchaseReturn({ commit }, data) {
        try {
            commit('purchaseReturn_request');
            let res = await axios.post('http://localhost:5000/api/purchase/returns/add', data);
            if (res.data.success !== undefined) {
                commit('purchaseReturn_success', res);
            }else{
                return commit('purchaseReturn_error',res);
    ...
    async updatePurchaseReturn({ commit }, data) {
        try {
            commit('purchaseReturn_request');
            let res = await axios.post('http://localhost:5000/api/purchase/returns/update', data);
            if (res.data.success !== undefined) {
                commit('purchaseReturn_success', res);
            }else{
                return commit('purchaseReturn_error',res);
    ...
    async voidPurchaseReturn({ commit }, data) {
        try {
            commit('purchaseReturn_request');
            let res = await axios.post('http://localhost:5000/api/purchase/returns/void', data);
            if (res.data.success !== undefined) {
                commit('purchaseReturn_success', res);
            }else{
                return commit('purchaseReturn_error',res);
    ...
    async closePurchaseReturn({ commit }, data) {
        try {
            commit('purchaseReturn_request');
            let res = await axios.post('http://localhost:5000/api/purchase/returns/close', data);
            if (res.data.success !== undefined) {
                commit('purchaseReturn_success', res);
            }else{
                return commit('purchaseReturn_error',res);
    ...
    async openPurchaseReturn({ commit }, data) {
        try {
            commit('purchaseReturn_request');
            let res = await axios.post('http://localhost:5000/api/purchase/returns/open', data);
            if (res.data.success !== undefined) {
                commit('purchaseReturn_success', res);
            }else{
                return commit('purchaseReturn_error',res);
