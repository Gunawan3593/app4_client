...
const actions = {
    ...
    async checkUsername({ commit }, username) {
        ...
        let res = await axios.post('http://localhost:5000/api/users/checkuser', username);
    ...
    async checkUseremail({ commit }, email) {
        // Check for the unique Username
        let res = await axios.post('http://localhost:5000/api/users/checkemail', email);
    ...
    async checkUpdemail({ commit }, email) {
        // Check for the unique Username
        let res = await axios.post('http://localhost:5000/api/users/checkupdemail', email);
        commit('email_exists',res.data);
        return res;
    },
    // Update User
    async updateUser({
        ...
        try{
            ...
            let res = await axios.post('http://localhost:5000/api/users/updateuser', userData);
            if(res.data.success !== undefined) {
