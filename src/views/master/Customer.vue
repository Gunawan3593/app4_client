          ...
          >
            <v-card class="elevation-12">
              <v-toolbar
                ...
                flat
              >
                <v-toolbar-title>Input Data Customer</v-toolbar-title>
                <v-spacer></v-spacer>
                <v-toolbar-title>
                    <v-tooltip left>
...
export default {
  ...
  async mounted(){
    let data = await this.getCustomer();
  ...
  methods: {
    ...mapActions(['getCustomer','addCustomer','updateCustomer','deleteCustomer']),
    addData() {
        let data = {
            name: this.name,
        ...
        this.isloading = true;
        this.addCustomer(data).then(res => {
            if(res.data.success) {
    ...
    updateData() {
        ...
        this.isloading = true;
        this.updateCustomer(data).then(res => {
            if(res.data.success) {
    ...
    deleteItem(item) {
      ...
      this.deleteCustomer(data).then(res => {
          if(res.data.success){
